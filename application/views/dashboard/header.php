            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3 bottom">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <?php echo anchor('funcionarios', '<span><i class="fas fa-laptop-code"></i> Funcionários</span>', array('class' => 'nav-link')) ?>
                        </li>
                        <li class="nav-item">
                            <?php echo anchor('sala03', '<span><i class="fas fa-laptop-code"></i> A Sala 03</span>', array('class' => 'nav-link')) ?>
                        </li>
                        <li class="nav-item">
                            <?php echo anchor('portfolio', '<span><i class="fas fa-laptop-code"></i> Portfólio</span>', array('class' => 'nav-link')) ?>
                        </li>
                        <li class="nav-item">
                            <?php echo anchor('contato', '<span><i class="fas fa-laptop-code"></i> Contato</span>', array('class' => 'nav-link')) ?>
                        </li>
                    </ul>
                    <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted">
                        <span>Cadastros</span>
