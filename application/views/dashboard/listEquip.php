                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <?php if ($funcionarios->ativo == 1) { ?>
                                    <?= anchor('equipe/funcionarioativo/' . $funcionarios->id, '<i class="fas fa-toggle-on"></i>', array('title' => 'Desativar')) ?>
                                <?php } else { ?>
                                    <?= anchor('equipe/funcionarioinativo/' . $funcionarios->id, '<i class="fas fa-toggle-off"></i>', array('title' => 'Ativar')) ?>
                                <?php } ?>
                            </td>
                        </tr>
                    <?php } ?>
