...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="row">
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body first-card">
                    <a class="atalho-add" href="banners/adicionarbanner"><i class="fas fa-plus mr-2"></i> Adicionar novo banner</a>
                </div>
            </div>
        </div>
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body second-card">
                    <a class="listar-mentores" href="portfolio/adicionarprojeto"><i class="fas fa-plus mr-2"></i> Adicionar novo projeto</a>
                </div>
            </div>
        </div>
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-4">
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body second-card">
                    <a class="listar-mentores" href="equipe/adicionarequipe"><i class="fas fa-plus mr-2"></i> Adicionar novo funcionário</a>
                </div>
            </div>
        </div>
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-4">
