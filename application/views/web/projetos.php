        ...
        <div class="projects">
            <div class="uk-child-width-1-3@s uk-child-width-1-3@m  uk-grid-small" uk-grid>
                <?php foreach ($app_projetos as $projetos) { ?>
                    <div>
                        <div class="uk-inline">
                            <a href="projetos/visualizarprojetos/<?= $projetos->id ?>"><img class="imgDestaque" src="upload/galeria/projeto-destaque/<?= $projetos->destaque ?>" alt="<?= $projetos->titulo_projeto ?>"></a>
